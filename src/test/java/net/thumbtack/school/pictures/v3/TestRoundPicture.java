...
public class TestRoundPicture {
    ...
    @Test
    public void testSetCenter() throws GraphicException {
        RoundPicture roundPicture1 = new RoundPicture(new Point(10, 10), 10);
        roundPicture1.setCenter(new Point(20,30));
        Point point = new Point(20,30);
        assertEquals(point,roundPicture1.getCenter());
    }

    @Test
    public void testSetRadius() throws GraphicException{
        RoundPicture roundPicture1 = new RoundPicture(new Point(10, 10), 10);
        roundPicture1.setRadius(40);
        assertEquals(40,roundPicture1.getRadius());
    }
